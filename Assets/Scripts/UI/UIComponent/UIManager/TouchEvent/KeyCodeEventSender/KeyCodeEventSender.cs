...
namespace BlackAm
{
    ...
    public abstract class KeyCodeTouchEventSenderBase : UIManagerBase, IKeyCodeTouchEventSender
    {
        ...
        protected void OnDialogueEventPointerDown(PointerEventData p_EventData)
        {
        }
        
        protected void OnDialogueEventPointerUp(PointerEventData p_EventData)
        {
            TouchEventManager.GetInstance.OnDialogueActioned(p_EventData);
        }
                ...
                if (TouchEventFlagMask.HasAnyFlagExceptNone(touchEventType))
                {
                    switch (touchEventType)
                    {
                        ...
                        case TouchEventRoot.TouchInputType.UnitClickEvent:
                            ...
                            break;
                        case TouchEventRoot.TouchInputType.DialogueEvent:
                            OnDialogueEventPointerDown(p_EventData);
                            break;
                    }
                }
            }
                ...
                if (TouchEventFlagMask.HasAnyFlagExceptNone(touchEventType))
                {
                    switch (touchEventType)
                    {
                        case TouchEventRoot.TouchInputType.KeyCodeEvent:
                            ...
                            break;
                        case TouchEventRoot.TouchInputType.DialogueEvent:
                            OnDialogueEventPointerUp(p_EventData);
                            break;
                    }
                }
            }
