...
namespace BlackAm
{
    ...
    public class LamierePlayerDeploySceneEnvironment : GamePlaySceneEnvironmentBase
    {
        ...
        public override async UniTask OnScenePreload()
        {
            ...
            Debug.Log($"[Log] Server Node : ZoneToDemonEvent Requested.({HeadlessServerManager.GetInstance.CurrentSceneEntryIndex}/{HeadlessServerManager.GetInstance.CurrentChannelIndex})");
