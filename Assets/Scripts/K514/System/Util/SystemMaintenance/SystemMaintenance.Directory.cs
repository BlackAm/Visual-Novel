...
namespace BlackAm
{
    public partial class SystemMaintenance
    {
        ...
        {
            if (!Directory.Exists(SaveDataFileDirectory))
            {
                Directory.CreateDirectory(SaveDataFileDirectory);
            }
            if (!Directory.Exists(SaveDataImageDirectory))
            {
                Directory.CreateDirectory(SaveDataImageDirectory);
            }
            if (!Directory.Exists(SaveReadDialogueDirectory))
            {
                Directory.CreateDirectory(SaveReadDialogueDirectory);
            }
            if (!Directory.Exists(SaveGalleryDirectory))
            {
                Directory.CreateDirectory(SaveGalleryDirectory);
            }
