...
{
    public class ServerPopSoundScript : MonoBehaviour
    {
        bool positionCheck;
        ...
        public MapEffectSoundManager.MapEffectSound mapEffectSound; //SFX_Table
        ...
        public void SetHeadName(string name,string prefabName, LabelIcon labelIcon = LabelIcon.Teal)
        {
            headName = name;
        ...
        private void OnDrawGizmos()
        {
            ...
            if(nameGameObject != null)
            {
                nameGameObject.name = $"{originalName} ({_SoundIndex} , {mapEffectSound})";
