    ...
    public partial class CameraManager
    {
        ...
        private void OnCreateBaseWrapperPartial()
        {
            _PlayerChangeEventReceiver = 
                PlayerManager.GetInstance.GetEventReceiver<PlayerChangeEventReceiver>(PlayerManager.PlayerChangeEventType.PlayerChanged, OnHandlePlayerChanged);
        }
        ...
        private void OnHandlePlayerChanged(PlayerManager.PlayerChangeEventType p_EventType, FocusableInstance p_TargetTransform)
        {
            switch (CurrentCameraMode)
            {
                case CameraMode.None:
                case CameraMode.ObjectTracing:
                    SetCameraModeTracingObject(p_TargetTransform);
                    break;
                case CameraMode.ObjectTracingSmoothLerp:
                    SetCameraModeSmoothTracingObject(p_TargetTransform);
                    break;
