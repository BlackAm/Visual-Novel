...
namespace k514
{
    ...
    /// </summary>
    public abstract class SceneChangeEventSingleton<Me> : Singleton<Me>, ISceneChangeObserve where Me : SceneChangeEventSingleton<Me>, new()
    {
        #region <Methods>
    ...
    /// </summary>
    public abstract class SceneChangeEventUnitySingleton<Me> : UnitySingleton<Me>, ISceneChangeObserve where Me : SceneChangeEventUnitySingleton<Me>
    {
        #region <Methods>
