namespace k514
{
    ...
    /// 이벤트를 수신받는 비교가능 풀링 오브젝트
    /// </summary>
    public abstract class EventTimerHandlerWrapper<M, K> : PoolingObject<M, K>, IEventTimerHandlerWrapper where K : EventTimerHandlerWrapper<M, K>, new() where M : struct
    {
        #region <Fields>
