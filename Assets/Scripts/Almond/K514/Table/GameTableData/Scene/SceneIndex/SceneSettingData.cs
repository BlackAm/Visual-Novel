...
namespace k514
{
    ...
    public class SceneSettingData : GameTable<SceneSettingData, int, SceneSettingData.TableRecord>
    {
        ...
        public class TableRecord : GameTableRecordBase
        {
            ...
            public Vector3 GetSamplePosition(bool p_SampleNavMeshSurface)
            {
                return PhysicsTool.GetRandomNavMeshSurfacePosition(Vector3.zero, MapRadiusFromCoordZero, p_SampleNavMeshSurface);
            }
