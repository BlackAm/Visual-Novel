...
namespace k514
{
    ...
    public class UnitSpellTouchEventCommandTable : TouchEventCommandTableBase<UnitSpellTouchEventCommandTable, UnitSpellTouchEventCommandTable.TouchEventRecord>
    {
        public class TouchEventRecord : TouchEventRecordBase
        {
        }
        ...
        protected override string GetDefaultTableFileName()
        {
            return "UnitSpellTouchEventCommand";
        }
        ...
        public override TouchEventRoot.TouchMappingKeyCodeType GetThisLabelType()
        {
            return TouchEventRoot.TouchMappingKeyCodeType.UnitSpell;
        }
    }
