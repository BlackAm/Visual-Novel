    ...
    public partial class SystemBoot : UnitySingleton<SystemBoot>, ISceneChange
    {
        ...
        private void LateUpdate()
        {
            ...
            if (_CurrentPhase == SystemBootPhase.SystemsFunctional)
            {
                ...
                UnitInteractManager.GetInstance.OnUpdate(deltaTime);
#if SERVER_DRIVE
#else
                LamiereGameManager.GetInstanceUnSafe.OnUpdate(deltaTime);
                ...
                UnitInteractManager.GetInstance.OnLateUpdate(deltaTime);
        ...
        private void FixedUpdate()
        {
            ...
            if (_CurrentPhase == SystemBootPhase.SystemsFunctional)
            {
                ...
                UnitInteractManager.GetInstance.OnFixedUpdate(deltaTime);
            }
        }
        ...
        public void OnSceneTransition()
        {
            if (SceneControllerManager.GetInstance.IsSceneStable())
            {
                ...
                // 맵 이펙트 사운드 종료
                MapEffectSoundManager.GetInstance.ReleaseSFX();
#endif
            }
        }
