...
namespace k514
{
    ...
    public partial class SystemBoot
    {
        ...
        {
            typeof(UnitInteractManager), typeof(PrefabModelDataRoot),
#if SERVER_DRIVE
#else       
            typeof(DefaultUIManagerSet), typeof(SpriteSheetManager),
            typeof(PlayerManager), typeof(TouchEventManager), typeof(DirectionalLightController),
#endif
        };
        ...
        {
            typeof(UnitActionPresetData), typeof(UnitActionCommandIndexData),
            typeof(UnitAIDataRoot), typeof(UnitActionDataRoot),
            typeof(UnitAnimationDataRoot), typeof(UnitPhysicsDataRoot),
            typeof(UnitRenderDataRoot), typeof(UnitRoleDataRoot),
        };
        
        private static readonly Type[] PreLoadGameTableGroup1 =
        {
            typeof(SceneEnvironmentTypeMap),
            typeof(AnimatorMotionPresetData), 
            typeof(UnitInfoPresetData),
        };
        ...
        private static readonly Type[] PreLoadGameTableGroup5 =
        {
            ...
            typeof(SoundDataRoot),
#if SERVER_DRIVE
#else
            typeof(CameraConfigureData), typeof(CameraCommandTableData), 
            typeof(UnitHitInteractData), typeof(UnitHitFxData), typeof(UnitHitUISkinData),
            typeof(InformationData),
#endif
        };
            ...
            typeof(PrefabSpawnDataBase<,>)
                ...
                (
                    new[]
                    {
                        ...
                        typeof(AnimationControllerData), typeof(MotionPresetData),
                        typeof(UnitExpTableData),
                        typeof(ObjectDeployDataRoot),
                        typeof(SpawnPlayerNameData),
                        typeof(AnimationFallBackData),
#if !SERVER_DRIVE
                        typeof(ImageNameTableData),
                        typeof(UIParticleEffectData),
                        typeof(StoryTalkData),
                        typeof(RewardData),
                        typeof(ShaderNameTableData),
                        typeof(ItemDecomData),
#endif
                    }
                )
                .ToArray();
