...
namespace k514
{
    public class VolitionalHero : VolitionalBase
    {
        #region <Consts>
        ...
        private new UnitRoleHeroPresetData.RoleTableRecord _RoleRecord;
        ...
        public override IVolitional OnInitializeRole(UnitRoleDataRoot.UnitRoleType p_RoleType, Unit p_TargetUnit, IVolitionalTableRecordBridge p_RolePreset)
        {
            ...
            _RoleRecord = (UnitRoleHeroPresetData.RoleTableRecord) p_RolePreset;
