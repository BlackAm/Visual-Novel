...
namespace k514
{
    public class VolitionalBoss : VolitionalBase
    {
        #region <Consts>
        ...
        private new UnitRoleBossPresetData.RoleTableRecord _RoleRecord;
        ...
        public override IVolitional OnInitializeRole(UnitRoleDataRoot.UnitRoleType p_RoleType, Unit p_TargetUnit, IVolitionalTableRecordBridge p_RolePreset)
        {
            ...
            _RoleRecord = (UnitRoleBossPresetData.RoleTableRecord) p_RolePreset;
