...
namespace k514
{
    public static class TransformTool
    {
        ...
        public struct AffineCachePreset
        {
            ...
            public AffineCachePreset(Unit p_Unit, bool p_ApplyHeight) : this(p_Unit._Transform)
            {
                if (p_ApplyHeight)
                {
                    AddLocalPositionOffset(p_Unit.GetHeightOffsetVector(0.5f), false);
                }
            }
            ...
            public static implicit operator AffineCachePreset(Unit p_Unit)
            {
                return new AffineCachePreset(p_Unit);
            }
        ...
        // TODO<K514> : AffineCachedPreset으로 병합할것
