        ...
        public void TurnSceneTo(SceneControllerTool.SceneControllerShortCutType p_SceneType, SceneControlPreset p_SceneControlPreset = default)
        {
            switch (p_SceneType)
            {
                ...
                case SceneControllerTool.SceneControllerShortCutType.MainHomeScene:
                    TurnSceneTo(SceneDataRoot.SceneDataType.MainScene, 1, 0, p_SceneControlPreset);
                    break;
                case SceneControllerTool.SceneControllerShortCutType.DialogueScene:
                    TurnSceneTo(SceneDataRoot.SceneDataType.DialogueScene, 0, 0, p_SceneControlPreset);
                    break;
